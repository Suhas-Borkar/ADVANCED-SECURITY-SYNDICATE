...
export default function PerformanceView() {
  ...
  const [compression, setCompression] = useState<string>("h265p");
  ...
  const calculateStorage = () => {
    ...
    const totalGB =
      (bitrate * 1000 * 1000 * 3600 * recordingHours * days * cameraCount) /
      (8 * 1000 * 1000 * 1000);
    ...
    <div className="bg-slate-50 min-h-screen">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-10 shadow-sm space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label className="text-xs font-mono font-black text-slate-500 uppercase flex justify-between">
                  <span>Number of Cameras:</span>
                  <span className="text-brand-600 font-extrabold">{cameraCount} CH</span>
                </label>
                <input
                  type="range" min="1" max="128" value={cameraCount}
                ...
                <div className="flex justify-between text-[10px] font-mono text-slate-400">
                  <span>1 CH</span><span>64 CH</span><span>128 CH</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  type="range" min="7" max="120" value={days}
                  onChange={(e) => setDays(parseInt(e.target.value))}
                  className="w-full h-1.5 bg-slate-100 rounded-lg appearance-none cursor-pointer accent-brand-600"
                />
                <div className="flex justify-between text-[10px] font-mono text-slate-400">
                  <span>7 Days</span><span>60 Days</span><span>120 Days</span>
                </div>
              </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-gradient-to-br from-brand-900 to-brand-700 text-white rounded-3xl p-8 shadow-lg relative overflow-hidden">
              ...
              <div className="p-4 bg-white/10 rounded-xl border border-white/10 text-xs font-sans text-slate-200">
                Based on continuous loop operations, smart H.265+ coding will save you roughly{" "}
                <span className="font-bold text-white uppercase font-mono">~72% of hard disk costs</span>{" "}
                compared to legacy H.264 systems.
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-sm space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <span className="text-xs font-mono font-bold text-slate-500 block uppercase">RECOMMENDED UNIT MODEL:</span>
                  <p className="font-display font-extrabold text-base text-slate-900 mt-1">{recommendation.model}</p>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-4 bg-slate-900 hover:bg-brand-600 text-white font-display font-bold rounded-xl text-xs transition-all flex items-center justify-center gap-2 shadow"
                >
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white border border-slate-200 rounded-3xl mb-24">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-xs text-slate-600 font-sans leading-relaxed">
