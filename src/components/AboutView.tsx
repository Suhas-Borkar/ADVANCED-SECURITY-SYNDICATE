...
import { 
  Briefcase, GraduationCap, Trophy, ChevronRight, 
  MapPin, Milestone, Star, Award, ShieldAlert, HeartHandshake, Mail 
} from "lucide-react";
...
export default function AboutView({ onOpenConsultation }: AboutViewProps) {
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      {/* 1. Hero Section - Brand Impact Report */}
      ...
      {/* 3. Deep-Dive Tabs (Vision, Interactive Timeline, Ethics) */}
      <section className="py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex border-b border-slate-250 mb-12 justify-center">
          {[
        ...
        {activeTab === "vision" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center animate-fade-in">
              ...
              <div className="space-y-3 pt-2">
                {[
                  ...
                  <div key={idx} className="flex gap-2 items-center text-slate-800 text-xs font-semibold">
                    <HeartHandshake className="w-4.5 h-4.5 text-brand-600 shrink-0" />
                    {item}
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-br from-brand-600 to-indigo-750 p-8 rounded-3xl text-white space-y-6 shadow-lg shadow-brand-900/10">
        ...
        {activeTab === "timeline" && (
          <div className="relative border-l border-slate-250 ml-4 pl-8 space-y-12 animate-fade-in py-4">
            {milestones.map((st, sIdx) => (
              <div key={sIdx} className="relative group">
                ...
                <p className="text-slate-500 text-xs sm:text-sm font-sans leading-relaxed mt-1 max-w-3xl">
                  {st.desc}
                </p>
              </div>
            ))}
        ...
        {activeTab === "compliance" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 animate-fade-in">
            <div className="border border-slate-205 p-6 rounded-2xl bg-white space-y-4">
      ...
      {/* 4. The Leadership Section with Direct Portraits */}
      <section className="py-24 bg-slate-100 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-xs font-mono font-bold text-brand-650 uppercase tracking-widest block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {LEADERSHIP.map((leader) => (
              ...
              >
                {/* Custom Generated Executive Portrait */}
                <div className="aspect-square bg-slate-100 overflow-hidden relative">
                  <img
                    ...
                    onError={(e) => {
                      // Fallback placeholder logic just in case
                ...
                <div className="p-6 space-y-3.5">
                  <div>
                    ...
                    <p className="text-xs font-mono text-brand-600 font-bold uppercase mt-0.5">
                      {leader.role}
                    </p>
                  </div>
                  <p className="text-slate-500 text-xs sm:text-sm font-sans leading-relaxed">
                  ...
                  <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-mono">
                    ...
                    <a 
                      ...
                      className="text-brand-600 hover:text-brand-850 font-bold flex items-center gap-1"
                    >
      ...
      <section className="py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <p className="text-slate-505 max-w-xl mx-auto text-sm sm:text-base leading-relaxed">
