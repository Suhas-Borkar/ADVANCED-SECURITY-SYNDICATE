...
import { 
  ...
  ChevronRight, ArrowUpRight, Search, FileDown, Stars 
} from "lucide-react";
import { BRANDS, SERVICES, TESTIMONIALS } from "../data";
...
export default function HomeView({ setCurrentPage, onOpenConsultation, onDownloadBrochure }: HomeViewProps) {
  ...
  return (
    <div className="bg-slate-50 relative">
      {/* 1. Hero Section with dynamic background image and grid mesh overlay */}
      <section className="relative min-h-[90vh] flex items-center bg-slate-950 overflow-hidden">
        {/* Background Image with blur & darkness overlays */}
        <div className="absolute inset-0 z-0">
          <img
            src="/src/assets/images/acgr_hero_surveillance_1782124477760.jpg"
      ...
      {/* 2. Numerical Performance Dashboard Block */}
      ...
      {/* 3. "Leading the distribution industry" section (Aesthetic 2-column layout) */}
      ...
      {/* 4. Active Alliance Logo Ticker Panel */}
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12 md:gap-16">
            {BRANDS.map((brand) => (
              ...
              >
                ...
                <span className="font-display font-bold text-slate-950 text-sm sm:text-base">
                  {brand.name}
                </span>
      ...
      {/* 5. Featured Services Blocks */}
      <section className="py-24 bg-slate-100/50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-xs font-mono font-bold text-brand-600 uppercase tracking-widest font-mono">
              Certified Services
            </span>
      ...
      {/* 6. Why Choose ACGR (The 6 Pillars bento layout) */}
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* 7. How Our Distribution Works (Sequential flow) */}
      <section className="py-24 bg-slate-900 text-slate-100 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            <div className="hidden md:absolute top-1/2 left-[15%] right-[15%] h-0.5 border-t border-dashed border-slate-700 z-0" />
      ...
      {/* 8. Micro Testimonial Carousel Section */}
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-brand-900 to-indigo-950 rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden shadow-xl">
          ...
          <div className="relative max-w-3xl">
            ...
            {/* Testimonials indicator triggers */}
          ...
          <div className="bg-white rounded-3xl border border-slate-200 w-full max-w-2xl overflow-hidden shadow-2xl animate-scale-up">
            ...
            <div className="p-8 space-y-6">
              <div>
                ...
                <p className="text-slate-600 font-sans text-sm mt-1 leading-relaxed">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2">
                  {selectedBrand.featuredProducts.map((p, idx) => (
                    <div key={idx} className="p-3 bg-slate-50 border border-slate-250 rounded-xl text-xs font-sans text-slate-705 flex gap-2 items-center">
                      <span className="w-1.5 h-1.5 rounded-full bg-brand-500 shrink-0" />
                      {p}
                    </div>
                  ))}
