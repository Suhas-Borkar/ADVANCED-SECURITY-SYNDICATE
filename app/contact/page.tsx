...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Advanced Security Syndicate. Office No. 06, Narshinha Residency, Opp Union Bank, New Sangavi, Pune – 411027. Phone: +91 9689147700. Email: advancescrtcp55@gmail.com.",
  openGraph: {
