...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Advanced Security Syndicate. Office No. 06, Narshinha Residency, Opp Union Bank, New Sangavi, Pune – 411027. Phone: +91 8830851805 | +91 9689147700. Email: advancedssyn@gmail.com.",
  openGraph: {
    ...
    images: [{ url: "/logo/logo.jpeg", alt: "Contact Advanced Security Syndicate" }],
  },
  twitter: {
    title: "Contact Advanced Security Syndicate",
