...
export const BRANDS: Brand[] = [
  ...
  },
  {
    ...
    description: "Computer peripherals and accessories for workstations, control rooms, and connected office setups.",
    longDescription: "iVOOMi is positioned as a dependable source for computer peripherals and accessories that support modern workspaces and security operations — including keyboards, mice, monitors, UPS systems, and related hardware. The focus is on reliable everyday equipment rather than camera manufacturing.",
    category: "Accessories",
    featuredProducts: ["USB Keyboards & Mice", "Business Monitors", "UPS Systems", "Connectivity Cables & Adapters"],
    foundedYear: "2016",
    relationshipType: "Regional Distributor",
    website: "#",
    content:"cover"
  },
  {
    ...
    longDescription: "Zebion (The Tech Truth) delivers dependable computer peripherals and accessories that support surveillance control room setups — keyboards, mice, monitors, UPS systems, and connectivity gear built for continuous 24/7 operational environments.",
    category: "Accessories",
